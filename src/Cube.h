...
public:
    ...
    explicit Cube(AK::Badge<Cube>, std::string diffuse_texture_path, std::shared_ptr<Material> const& material);
    explicit Cube(AK::Badge<Cube>, std::string diffuse_texture_path, std::string specular_texture_path, std::shared_ptr<Material> const& material);
