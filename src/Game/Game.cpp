...
void Game::initialize()
{
    ...
    auto const glitter_shader = ShaderFactory::create("./res/shaders/glitter.hlsl", "./res/shaders/glitter.hlsl");
    auto const halo_shader = ShaderFactory::create("./res/shaders/halo.hlsl", "./res/shaders/halo.hlsl");
    ...
    auto const glitter_material = Material::create(glitter_shader);
    ...
    scene->add_component(Model::create("./res/models/scene/scene.gltf", glitter_material));
    ...
    keeper->add_component(Model::create("./res/models/keeper/keeper.gltf", halo_material));
    keeper->add_component(LighthouseKeeper::create());
    keeper->transform->set_local_position({ 0.0f, 0.0f, 3.0f });
    keeper->transform->set_local_scale(glm::vec3(0.1f));
}
